...
RUN brew update && \
    ...
    brew cleanup -s && \
    rm -rf $(brew --cache)
RUN curl -LO https://github.com/mstorsjo/llvm-mingw/releases/download/20240518/llvm-mingw-20240518-msvcrt-ubuntu-20.04-x86_64.tar.xz && \
    tar xf llvm-mingw-20240518-msvcrt-ubuntu-20.04-x86_64.tar.xz && \
    sudo mv llvm-mingw-20240518-msvcrt-ubuntu-20.04-x86_64 /opt/llvm-mingw && \
    rm llvm-mingw-20240518-msvcrt-ubuntu-20.04-x86_64.tar.xz
